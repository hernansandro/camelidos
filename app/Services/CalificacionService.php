...
class CalificacionService
{
    ...
    {
        return Calificacion::with('project')->where('project_id', $projectId)
            ->orderBy('priority')->get();
    }

    public function getById(int $id)
    {
        return Calificacion::where('id', $id)->first();
    }

    public function store($data): void
    {
        //$count = Calificacion::where('project_id', $data['project_id'])->count();
    ...
    {
        $items = Calificacion::where('project_id', $project_id)
        ...
        $table_name = (new Calificacion())->getTable();
