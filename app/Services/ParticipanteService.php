...
class ParticipanteService
{
    ...
    {
        return Participante::with('project')->where('project_id', $projectId)
            ->orderBy('priority')->get();
    }

    public function getById(int $id)
    {
        return Participante::where('id', $id)->first();
    }

    public function store($data): void
    {
        //$count = Participante::where('project_id', $data['project_id'])->count();
    ...
    {
        $items = Participante::where('project_id', $project_id)
        ...
        $table_name = (new Participante())->getTable();
